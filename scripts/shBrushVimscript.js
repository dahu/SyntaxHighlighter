...
SyntaxHighlighter.brushes.Vimscript = function()
{
  ...
  var funcs = 'append bufexists buflisted bufloaded bufname bufnr bufwinnr clearmatches ' +
    'complete complete_add complete_check confirm count cscope_connection cursor cursor deepcopy delete ' +
    'did_filetype diff_filler diff_hlID empty escape eventhandler executable exists extend expand feedkeys ' +
    'filereadable filewritable filter finddir findfile float2nr floor fnameescape fnamemodify foldclosed ' +
    'foldclosedend foldlevel foldtext foldtextresult foreground function garbagecollect getbufline getbufvar ' +
    'getchar getcharmod getcmdline getcmdpos getcmdtype getcwd getfperm getfsize getfontname getftime ' +
    ...
    'reverse round search searchdecl searchpair searchpairpos searchpos server2client serverlist setbufvar ' +
    'setcmdpos setline setloclist setmatches setpos setqflist setreg settabvar settabwinvar setwinvar shellescape ' +
    'simplify soundfold spellbadword spellsuggest split str2float str2nr strchars strdisplaywidth strftime ' +
    'stridx string strlen strpart strridx strtrans strwidth submatch substitute synID synIDattr synIDtrans ' +
    'synconcealed synstack system tabpagebuflist tabpagenr tabpagewinnr taglist tagfiles tempname tolower ' +
